...
export type SetAsLoggedInMutation = { setAsLoggedIn: { __typename?: 'UserStatus', username: string, isLoggedIn: boolean, loginTime: string, permissions: Array<Permission>, activeChannelId?: string | null, channels: Array<{ __typename?: 'CurrentUserChannel', id: string, token: string, code: string, permissions: Array<Permission> }> } };

export type SetAsLoggedOutMutationVariables = Exact<{ [key: string]: never; }>;


export type SetAsLoggedOutMutation = { setAsLoggedOut: { __typename?: 'UserStatus', username: string, isLoggedIn: boolean, loginTime: string, permissions: Array<Permission>, activeChannelId?: string | null, channels: Array<{ __typename?: 'CurrentUserChannel', id: string, token: string, code: string, permissions: Array<Permission> }> } };
...
export type SetUiLanguageMutation = { setUiLanguage: LanguageCode };
...
export type SetActiveChannelMutation = { setActiveChannel: { __typename?: 'UserStatus', username: string, isLoggedIn: boolean, loginTime: string, permissions: Array<Permission>, activeChannelId?: string | null, channels: Array<{ __typename?: 'CurrentUserChannel', id: string, token: string, code: string, permissions: Array<Permission> }> } };
...
export type UpdateUserChannelsMutation = { updateUserChannels: { __typename?: 'UserStatus', username: string, isLoggedIn: boolean, loginTime: string, permissions: Array<Permission>, activeChannelId?: string | null, channels: Array<{ __typename?: 'CurrentUserChannel', id: string, token: string, code: string, permissions: Array<Permission> }> } };

export type NetworkStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type NetworkStatusQuery = { networkStatus: { __typename?: 'NetworkStatus', inFlightRequests: number } };

export type UserStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type UserStatusQuery = { userStatus: { __typename?: 'UserStatus', username: string, isLoggedIn: boolean, loginTime: string, permissions: Array<Permission>, activeChannelId?: string | null, channels: Array<{ __typename?: 'CurrentUserChannel', id: string, token: string, code: string, permissions: Array<Permission> }> } };

export type UiStateQueryVariables = Exact<{ [key: string]: never; }>;


export type UiStateQuery = { uiState: { __typename?: 'UiState', language: LanguageCode, locale?: string | null, contentLanguage: LanguageCode, theme: string, displayUiExtensionPoints: boolean } };


export const RequestStartedDocument = gql`
    mutation requestStarted {
  requestStarted
}
    `;
export type RequestStartedMutationFn = Apollo.MutationFunction<RequestStartedMutation, RequestStartedMutationVariables>;

/**
 * __useRequestStartedMutation__
 *
 * To run a mutation, you first call `useRequestStartedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRequestStartedMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [requestStartedMutation, { data, loading, error }] = useRequestStartedMutation({
 *   variables: {
 *   },
 * });
 */
export function useRequestStartedMutation(baseOptions?: Apollo.MutationHookOptions<RequestStartedMutation, RequestStartedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RequestStartedMutation, RequestStartedMutationVariables>(RequestStartedDocument, options);
      }
export type RequestStartedMutationHookResult = ReturnType<typeof useRequestStartedMutation>;
export type RequestStartedMutationResult = Apollo.MutationResult<RequestStartedMutation>;
export type RequestStartedMutationOptions = Apollo.BaseMutationOptions<RequestStartedMutation, RequestStartedMutationVariables>;
export const RequestCompletedDocument = gql`
    mutation requestCompleted {
  requestCompleted
}
    `;
export type RequestCompletedMutationFn = Apollo.MutationFunction<RequestCompletedMutation, RequestCompletedMutationVariables>;

/**
 * __useRequestCompletedMutation__
 *
 * To run a mutation, you first call `useRequestCompletedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRequestCompletedMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [requestCompletedMutation, { data, loading, error }] = useRequestCompletedMutation({
 *   variables: {
 *   },
 * });
 */
export function useRequestCompletedMutation(baseOptions?: Apollo.MutationHookOptions<RequestCompletedMutation, RequestCompletedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RequestCompletedMutation, RequestCompletedMutationVariables>(RequestCompletedDocument, options);
      }
export type RequestCompletedMutationHookResult = ReturnType<typeof useRequestCompletedMutation>;
export type RequestCompletedMutationResult = Apollo.MutationResult<RequestCompletedMutation>;
export type RequestCompletedMutationOptions = Apollo.BaseMutationOptions<RequestCompletedMutation, RequestCompletedMutationVariables>;
export const SetAsLoggedInDocument = gql`
    mutation setAsLoggedIn($input: UserStatusInput!) {
  setAsLoggedIn(input: $input) {
    username
    isLoggedIn
    loginTime
    permissions
    ...
    `;
export type SetAsLoggedInMutationFn = Apollo.MutationFunction<SetAsLoggedInMutation, SetAsLoggedInMutationVariables>;

/**
 * __useSetAsLoggedInMutation__
 *
 * To run a mutation, you first call `useSetAsLoggedInMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetAsLoggedInMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setAsLoggedInMutation, { data, loading, error }] = useSetAsLoggedInMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSetAsLoggedInMutation(baseOptions?: Apollo.MutationHookOptions<SetAsLoggedInMutation, SetAsLoggedInMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetAsLoggedInMutation, SetAsLoggedInMutationVariables>(SetAsLoggedInDocument, options);
      }
export type SetAsLoggedInMutationHookResult = ReturnType<typeof useSetAsLoggedInMutation>;
export type SetAsLoggedInMutationResult = Apollo.MutationResult<SetAsLoggedInMutation>;
export type SetAsLoggedInMutationOptions = Apollo.BaseMutationOptions<SetAsLoggedInMutation, SetAsLoggedInMutationVariables>;
export const SetAsLoggedOutDocument = gql`
  ...
  setAsLoggedOut {
    ...
    `;
export type SetAsLoggedOutMutationFn = Apollo.MutationFunction<SetAsLoggedOutMutation, SetAsLoggedOutMutationVariables>;

/**
 * __useSetAsLoggedOutMutation__
 *
 * To run a mutation, you first call `useSetAsLoggedOutMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetAsLoggedOutMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setAsLoggedOutMutation, { data, loading, error }] = useSetAsLoggedOutMutation({
 *   variables: {
 *   },
 * });
 */
export function useSetAsLoggedOutMutation(baseOptions?: Apollo.MutationHookOptions<SetAsLoggedOutMutation, SetAsLoggedOutMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetAsLoggedOutMutation, SetAsLoggedOutMutationVariables>(SetAsLoggedOutDocument, options);
      }
export type SetAsLoggedOutMutationHookResult = ReturnType<typeof useSetAsLoggedOutMutation>;
export type SetAsLoggedOutMutationResult = Apollo.MutationResult<SetAsLoggedOutMutation>;
export type SetAsLoggedOutMutationOptions = Apollo.BaseMutationOptions<SetAsLoggedOutMutation, SetAsLoggedOutMutationVariables>;
export const SetUiLanguageDocument = gql`
    mutation setUiLanguage($languageCode: LanguageCode!) {
  setUiLanguage(languageCode: $languageCode)
}
    `;
export type SetUiLanguageMutationFn = Apollo.MutationFunction<SetUiLanguageMutation, SetUiLanguageMutationVariables>;

/**
 * __useSetUiLanguageMutation__
 *
 * To run a mutation, you first call `useSetUiLanguageMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetUiLanguageMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setUiLanguageMutation, { data, loading, error }] = useSetUiLanguageMutation({
 *   variables: {
 *      languageCode: // value for 'languageCode'
 *   },
 * });
 */
export function useSetUiLanguageMutation(baseOptions?: Apollo.MutationHookOptions<SetUiLanguageMutation, SetUiLanguageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetUiLanguageMutation, SetUiLanguageMutationVariables>(SetUiLanguageDocument, options);
      }
export type SetUiLanguageMutationHookResult = ReturnType<typeof useSetUiLanguageMutation>;
export type SetUiLanguageMutationResult = Apollo.MutationResult<SetUiLanguageMutation>;
export type SetUiLanguageMutationOptions = Apollo.BaseMutationOptions<SetUiLanguageMutation, SetUiLanguageMutationVariables>;
export const SetUiLocaleDocument = gql`
    mutation setUiLocale($locale: String) {
  setUiLocale(locale: $locale)
}
    `;
export type SetUiLocaleMutationFn = Apollo.MutationFunction<SetUiLocaleMutation, SetUiLocaleMutationVariables>;

/**
 * __useSetUiLocaleMutation__
 *
 * To run a mutation, you first call `useSetUiLocaleMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetUiLocaleMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setUiLocaleMutation, { data, loading, error }] = useSetUiLocaleMutation({
 *   variables: {
 *      locale: // value for 'locale'
 *   },
 * });
 */
export function useSetUiLocaleMutation(baseOptions?: Apollo.MutationHookOptions<SetUiLocaleMutation, SetUiLocaleMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetUiLocaleMutation, SetUiLocaleMutationVariables>(SetUiLocaleDocument, options);
      }
export type SetUiLocaleMutationHookResult = ReturnType<typeof useSetUiLocaleMutation>;
export type SetUiLocaleMutationResult = Apollo.MutationResult<SetUiLocaleMutation>;
export type SetUiLocaleMutationOptions = Apollo.BaseMutationOptions<SetUiLocaleMutation, SetUiLocaleMutationVariables>;
export const SetContentLanguageDocument = gql`
    mutation setContentLanguage($languageCode: LanguageCode!) {
  setContentLanguage(languageCode: $languageCode)
}
    `;
export type SetContentLanguageMutationFn = Apollo.MutationFunction<SetContentLanguageMutation, SetContentLanguageMutationVariables>;

/**
 * __useSetContentLanguageMutation__
 *
 * To run a mutation, you first call `useSetContentLanguageMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetContentLanguageMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setContentLanguageMutation, { data, loading, error }] = useSetContentLanguageMutation({
 *   variables: {
 *      languageCode: // value for 'languageCode'
 *   },
 * });
 */
export function useSetContentLanguageMutation(baseOptions?: Apollo.MutationHookOptions<SetContentLanguageMutation, SetContentLanguageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetContentLanguageMutation, SetContentLanguageMutationVariables>(SetContentLanguageDocument, options);
      }
export type SetContentLanguageMutationHookResult = ReturnType<typeof useSetContentLanguageMutation>;
export type SetContentLanguageMutationResult = Apollo.MutationResult<SetContentLanguageMutation>;
export type SetContentLanguageMutationOptions = Apollo.BaseMutationOptions<SetContentLanguageMutation, SetContentLanguageMutationVariables>;
export const SetUiThemeDocument = gql`
    mutation setUiTheme($theme: String!) {
  setUiTheme(theme: $theme)
}
    `;
export type SetUiThemeMutationFn = Apollo.MutationFunction<SetUiThemeMutation, SetUiThemeMutationVariables>;
 ...
 * });
 */
export function useSetUiThemeMutation(baseOptions?: Apollo.MutationHookOptions<SetUiThemeMutation, SetUiThemeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetUiThemeMutation, SetUiThemeMutationVariables>(SetUiThemeDocument, options);
      }
export type SetUiThemeMutationHookResult = ReturnType<typeof useSetUiThemeMutation>;
export type SetUiThemeMutationResult = Apollo.MutationResult<SetUiThemeMutation>;
export type SetUiThemeMutationOptions = Apollo.BaseMutationOptions<SetUiThemeMutation, SetUiThemeMutationVariables>;
export const SetActiveChannelDocument = gql`
  ...
  setActiveChannel(channelId: $channelId) {
    ...
    `;
export type SetActiveChannelMutationFn = Apollo.MutationFunction<SetActiveChannelMutation, SetActiveChannelMutationVariables>;

/**
 * __useSetActiveChannelMutation__
 *
 * To run a mutation, you first call `useSetActiveChannelMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetActiveChannelMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setActiveChannelMutation, { data, loading, error }] = useSetActiveChannelMutation({
 *   variables: {
 *      channelId: // value for 'channelId'
 *   },
 * });
 */
export function useSetActiveChannelMutation(baseOptions?: Apollo.MutationHookOptions<SetActiveChannelMutation, SetActiveChannelMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetActiveChannelMutation, SetActiveChannelMutationVariables>(SetActiveChannelDocument, options);
      }
export type SetActiveChannelMutationHookResult = ReturnType<typeof useSetActiveChannelMutation>;
export type SetActiveChannelMutationResult = Apollo.MutationResult<SetActiveChannelMutation>;
export type SetActiveChannelMutationOptions = Apollo.BaseMutationOptions<SetActiveChannelMutation, SetActiveChannelMutationVariables>;
export const SetDisplayUiExtensionPointsDocument = gql`
    mutation setDisplayUiExtensionPoints($display: Boolean!) {
  setDisplayUiExtensionPoints(display: $display)
}
    `;
export type SetDisplayUiExtensionPointsMutationFn = Apollo.MutationFunction<SetDisplayUiExtensionPointsMutation, SetDisplayUiExtensionPointsMutationVariables>;

/**
 * __useSetDisplayUiExtensionPointsMutation__
 *
 * To run a mutation, you first call `useSetDisplayUiExtensionPointsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetDisplayUiExtensionPointsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setDisplayUiExtensionPointsMutation, { data, loading, error }] = useSetDisplayUiExtensionPointsMutation({
 *   variables: {
 *      display: // value for 'display'
 *   },
 * });
 */
export function useSetDisplayUiExtensionPointsMutation(baseOptions?: Apollo.MutationHookOptions<SetDisplayUiExtensionPointsMutation, SetDisplayUiExtensionPointsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetDisplayUiExtensionPointsMutation, SetDisplayUiExtensionPointsMutationVariables>(SetDisplayUiExtensionPointsDocument, options);
      }
export type SetDisplayUiExtensionPointsMutationHookResult = ReturnType<typeof useSetDisplayUiExtensionPointsMutation>;
export type SetDisplayUiExtensionPointsMutationResult = Apollo.MutationResult<SetDisplayUiExtensionPointsMutation>;
export type SetDisplayUiExtensionPointsMutationOptions = Apollo.BaseMutationOptions<SetDisplayUiExtensionPointsMutation, SetDisplayUiExtensionPointsMutationVariables>;
export const UpdateUserChannelsDocument = gql`
    mutation updateUserChannels($channels: [CurrentUserChannelInput!]!) {
  updateUserChannels(channels: $channels) {
    username
    isLoggedIn
    loginTime
    permissions
    ...
    `;
export type UpdateUserChannelsMutationFn = Apollo.MutationFunction<UpdateUserChannelsMutation, UpdateUserChannelsMutationVariables>;

/**
 * __useUpdateUserChannelsMutation__
 *
 * To run a mutation, you first call `useUpdateUserChannelsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserChannelsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateUserChannelsMutation, { data, loading, error }] = useUpdateUserChannelsMutation({
 *   variables: {
 *      channels: // value for 'channels'
 *   },
 * });
 */
export function useUpdateUserChannelsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateUserChannelsMutation, UpdateUserChannelsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateUserChannelsMutation, UpdateUserChannelsMutationVariables>(UpdateUserChannelsDocument, options);
      }
export type UpdateUserChannelsMutationHookResult = ReturnType<typeof useUpdateUserChannelsMutation>;
export type UpdateUserChannelsMutationResult = Apollo.MutationResult<UpdateUserChannelsMutation>;
export type UpdateUserChannelsMutationOptions = Apollo.BaseMutationOptions<UpdateUserChannelsMutation, UpdateUserChannelsMutationVariables>;
 ...
 * });
 */
export function useNetworkStatusQuery(baseOptions?: Apollo.QueryHookOptions<NetworkStatusQuery, NetworkStatusQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<NetworkStatusQuery, NetworkStatusQueryVariables>(NetworkStatusDocument, options);
      }
export function useNetworkStatusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<NetworkStatusQuery, NetworkStatusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<NetworkStatusQuery, NetworkStatusQueryVariables>(NetworkStatusDocument, options);
        }
...
export type NetworkStatusQueryResult = Apollo.QueryResult<NetworkStatusQuery, NetworkStatusQueryVariables>;
...
export const UiStateDocument = gql`
    query uiState {
  uiState {
    language
    locale
 ...
 * __useUiStateQuery__
 *
 * To run a query within a React component, call `useUiStateQuery` and pass it any options that fit your needs.
 * When your component renders, `useUiStateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUiStateQuery({
 *   variables: {
 *   },
 * });
 */
export function useUiStateQuery(baseOptions?: Apollo.QueryHookOptions<UiStateQuery, UiStateQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UiStateQuery, UiStateQueryVariables>(UiStateDocument, options);
      }
export function useUiStateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UiStateQuery, UiStateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UiStateQuery, UiStateQueryVariables>(UiStateDocument, options);
        }
export type UiStateQueryHookResult = ReturnType<typeof useUiStateQuery>;
export type UiStateLazyQueryHookResult = ReturnType<typeof useUiStateLazyQuery>;
export type UiStateQueryResult = Apollo.QueryResult<UiStateQuery, UiStateQueryVariables>;